    ...
    >
      <div className="flex justify-between w-full items-center">
        <section className="relative flex items-center">
          <Link to="/profile">
            <img
              className="rounded-full border-2  bg-gray-300 me-3 hover:bg-gray-500 cursor-pointer"
              src={defaultUser}
        ...
        <section className="flex items-center">
          <Link
            to="/products"
            className="mx-2 px-3 py-1 shadow-sm rounded-md text-white bg-gray-700 text-sm hover:bg-gray-800 transition"
          >
          ...
          <ul className=" hidden md:flex justify-between text-2xl ps-1">
            <li
              className="relative bg-gray-200  p-2 rounded-full hover:bg-gray-800 hover:text-white cursor-pointer mx-2 transition shadow-sm"
            ...
            <li
              className="relative bg-gray-500 text-white p-2 rounded-full hover:bg-gray-800 cursor-pointer mx-2 transition shadow-sm"
